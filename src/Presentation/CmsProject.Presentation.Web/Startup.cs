...
using CmsProject.Presentation.Web.Setup;

namespace CmsProject.Presentation.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UsuariosContexts>(options =>
                options.UseMySql(Configuration.GetConnectionString("Country32_Usuarios")))
            ...
            services.AddAutoMapper(typeof(Produtos), typeof(ProdutoDTO));
            services.AddAutoMapper(typeof(Catalogo.Domain.Catalogo), typeof(CatalagoDTO));
